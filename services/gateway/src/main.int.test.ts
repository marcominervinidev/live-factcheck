// Stage 2a: the gateway reads its Redis password from a secret file (`REDIS_PASSWORD_FILE`,
// the way Compose and Kubernetes mount secrets) and becomes ready against a real Redis.
...
describe('gateway with a secret file against a real Redis', () => {
